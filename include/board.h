...
typedef enum {
    BOARD_LCD_JOYSTICK_NONE = 0,
    BOARD_LCD_JOYSTICK_PRESS,
    BOARD_LCD_JOYSTICK_RIGHT,
    BOARD_LCD_JOYSTICK_LEFT,
    BOARD_LCD_JOYSTICK_UP,
    BOARD_LCD_JOYSTICK_DOWN
} board_lcd_joystick_direction_t;

typedef enum {
    BOARD_FIELD_UNKNOWN = 0,
    BOARD_FIELD_RED,
    BOARD_FIELD_BLUE
} board_field_t;
...
extern volatile uint32_t g_uart5_error_count;
extern volatile uint32_t g_rc_fault_epoch;
