...
#define ROUTE_FORWARD_DISTANCE_M 3.920f
...
#define ROUTE_TASK3_POST_FINAL_SHIFT_DISTANCE_BLUE_M 2.250f
#define ROUTE_TASK3_POST_FINAL_FORWARD_DISTANCE_RED_M 0.600f
#define ROUTE_TASK3_POST_FINAL_FORWARD_DISTANCE_BLUE_M 0.670f
...
/* The formal task-three tail uses only the H7-local PWM outputs. */
#define ROUTE_HTD85_AUX_ID3_SERVO_ID 3U /* generic remote-command validator */
