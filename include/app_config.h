...
/* Formal task-two makes a fixed 180 mm approach after the main-camera
 * white-line reference; keep it independent from the standalone test. */
#define ROUTE_TASK2_FORMAL_WHITE_LINE_AFTER_CROSSED_FORWARD_M 0.180f
...
#define ROUTE_TASK3_POST_FIRST_SHIFT_BLUE_M 0.220f
#define ROUTE_TASK3_POST_FINAL_SHIFT_DISTANCE_RED_M 2.700f
#define ROUTE_TASK3_POST_FINAL_SHIFT_DISTANCE_BLUE_M 2.280f
